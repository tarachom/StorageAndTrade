...
namespace StorageAndTrade
{
    public partial class Form_ПоступленняТоварівТаПослуг_ТабличнаЧастина_Товари : UserControl
    {
		...
		public void LoadRecords()
		{
			...
			querySelect.Joins.Add(new Join(JoinTable, Документи.ПоступленняТоварівТаПослуг_Товари_TablePart.Номенклатура, querySelect.Table));
			...
			querySelect.Joins.Add(new Join(JoinTable, Документи.ПоступленняТоварівТаПослуг_Товари_TablePart.Пакування, querySelect.Table));
			...
			querySelect.Joins.Add(new Join(JoinTable, Документи.ПоступленняТоварівТаПослуг_Товари_TablePart.ХарактеристикаНоменклатури, querySelect.Table));
