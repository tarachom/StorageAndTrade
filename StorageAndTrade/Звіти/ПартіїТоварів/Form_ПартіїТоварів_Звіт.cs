...
SELECT 
    ...
    (ПартіїТоварів_Місяць.{ВіртуальніТаблиціРегістрів.ПартіїТоварів_Місяць_TablePart.Документ}).datedoc AS Документ_ДатаДок,
...
ORDER BY Організація_Назва, Документ_ДатаДок ASC, Номенклатура_Назва, ХарактеристикаНоменклатури_Назва
";
