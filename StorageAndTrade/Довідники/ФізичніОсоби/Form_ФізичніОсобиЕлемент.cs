...
{
    public partial class Form_ФізичніОсобиЕлемент : Form
    {
        public Form_ФізичніОсобиЕлемент()
        {
            InitializeComponent();
        }
		...
		/// Форма списку
		/// </summary>
        public Form_ФізичніОсоби OwnerForm { get; set; }
        ...
        private void buttonSave_Click(object sender, EventArgs e)
        {
			if (IsNew.HasValue)
			{
				...
				if (OwnerForm != null)
				{
					OwnerForm.SelectPointerItem = фізичніОсоби_Objest.GetDirectoryPointer();
