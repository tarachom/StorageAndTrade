...
{
    partial class Form_ВстановленняЦінНоменклатуриЖурнал
    {
        /// <summary>
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Form_ВстановленняЦінНоменклатуриЖурнал));
            ...
            // 
            // Form_ВстановленняЦінНоменклатуриЖурнал
            // 
            ...
            this.Name = "Form_ВстановленняЦінНоменклатуриЖурнал";
