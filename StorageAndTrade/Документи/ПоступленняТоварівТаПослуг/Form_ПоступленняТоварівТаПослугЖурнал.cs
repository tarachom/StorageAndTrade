        ...
        private void розхіднийКасовийОрдерToolStripMenuItem_Click(object sender, EventArgs e)
        {
			if (dataGridViewRecords.SelectedRows.Count > 0)
			{
				...
				if (form_РозхіднийКасовийОрдерЖурнал == null)
				{
					...
					((Form_РозхіднийКасовийОрдерЖурнал)form_РозхіднийКасовийОрдерЖурнал).SelectPointerItem = розхіднийКасовийОрдер_Новий.GetDocumentPointer();
				...
				form_РозхіднийКасовийОрдерДокумент.Uid = розхіднийКасовийОрдер_Новий.UnigueID.ToString();
