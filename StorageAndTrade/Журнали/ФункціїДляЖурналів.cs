...
SELECT
    ...
    Док_ВведенняЗалишків.uid,
    Док_ВведенняЗалишків.spend,
    Док_ВведенняЗалишків.{Документи.ВнутрішнєСпоживанняТоварів_Const.Назва} AS Назва,
    Док_ВведенняЗалишків.{Документи.ВнутрішнєСпоживанняТоварів_Const.НомерДок} AS НомерДок,
    Док_ВведенняЗалишків.{Документи.ВнутрішнєСпоживанняТоварів_Const.ДатаДок} AS ДатаДок,
    '' AS КонтрагентНазва,
    0 AS Сума,
    Док_ВведенняЗалишків.{Документи.ВнутрішнєСпоживанняТоварів_Const.Коментар} AS Коментар
FROM
	{Документи.ВнутрішнєСпоживанняТоварів_Const.TABLE} AS Док_ВведенняЗалишків
";
