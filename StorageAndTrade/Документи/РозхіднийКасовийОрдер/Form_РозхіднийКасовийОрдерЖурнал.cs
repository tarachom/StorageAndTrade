...
namespace StorageAndTrade
{
    public partial class Form_РозхіднийКасовийОрдерЖурнал : Form
    {
        ...
        private void toolStripButtonAdd_Click(object sender, EventArgs e)
        {
			...
			form_РозхіднийКасовийОрдерДокумент.ShowDialog();
        }
        ...
        private void toolStripButtonДрукПроводок_Click(object sender, EventArgs e)
        {
			if (dataGridViewRecords.SelectedRows.Count > 0)
			{
				...
				Звіти.РухПоРугістрахНакопичення.PrintRecords(new Документи.РозхіднийКасовийОрдер_Pointer(new UnigueID(uid)));
			}
		}
