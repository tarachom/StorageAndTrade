...
namespace StorageAndTrade
{
    public partial class Form_БанківськіРахункиОрганізацій : Form
    {
		...
		private void Form_БанківськіРахункиОрганізацій_Load(object sender, EventArgs e)
        {
			LoadRecords();
		}
		...
		public void LoadRecords()
		{
			...
			банківськіРахункиОрганізацій_Select.QuerySelect.Field.Add(Довідники.БанківськіРахункиОрганізацій_Const.Код);
			...
			while (банківськіРахункиОрганізацій_Select.MoveNext())
			{
				...
				RecordsBindingList.Add(new Записи
				{
					...
					Код = cur.Fields[Довідники.БанківськіРахункиОрганізацій_Const.Код].ToString()
				});
			}
        ...
        private void dataGridViewRecords_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
			if (e.RowIndex >= 0 && e.RowIndex < dataGridViewRecords.RowCount)
			{
				...
				{
					DirectoryPointerItem = new Довідники.БанківськіРахункиОрганізацій_Pointer(new UnigueID(Uid));
				...
				MessageBox.Show("Копіювати записи?", "Повідомлення", MessageBoxButtons.YesNo) == DialogResult.Yes)
			{
				for (int i = 0; i < dataGridViewRecords.SelectedRows.Count; i++)
				{
                    ...
                    if (банківськіРахункиОрганізацій_Objest.Read(new UnigueID(uid)))
                    {
						...
						банківськіРахункиОрганізацій_Objest_Новий.Код = (++Константи.НумераціяДовідників.БанківськіРахункиОрганізацій_Const).ToString("D6");
        ...
        private void dataGridViewRecords_CellClick(object sender, DataGridViewCellEventArgs e)
        {
			if (dataGridViewRecords.SelectedRows.Count > 0)
			{
				...
				SelectPointerItem = new Довідники.БанківськіРахункиОрганізацій_Pointer(new UnigueID(dataGridViewRecords.Rows[e.RowIndex].Cells["ID"].Value.ToString()));
			}
		}
    }
}
