...
(
    ...
    {ВіртуальніТаблиціРегістрів.ПартіїТоварів_День_TablePart.ДокументПоступлення},
    {ВіртуальніТаблиціРегістрів.ПартіїТоварів_День_TablePart.Документ},
...
GROUP BY 
    period_day, Організація, ДокументПоступлення, Документ, Номенклатура, ХарактеристикаНоменклатури, Серія
HAVING 
   SUM(CASE WHEN Рег_ПартіїТоварів.income = true THEN 
        Рег_ПартіїТоварів.{ПартіїТоварів_Const.Кількість} ELSE 
...
(
    ...
    {ВіртуальніТаблиціРегістрів.ПартіїТоварів_Місяць_TablePart.ДокументПоступлення},
    {ВіртуальніТаблиціРегістрів.ПартіїТоварів_Місяць_TablePart.Документ},
...
SELECT 
    ...
    ПартіїТоварів_День.{ВіртуальніТаблиціРегістрів.ПартіїТоварів_День_TablePart.ДокументПоступлення} AS ДокументПоступлення,
    ПартіїТоварів_День.{ВіртуальніТаблиціРегістрів.ПартіїТоварів_День_TablePart.Документ} AS Документ,
...
GROUP BY 
    Період, Організація, ДокументПоступлення, Документ, Номенклатура, ХарактеристикаНоменклатури, Серія
HAVING 
...
";
        ...
        /// <summary>
        /// Обчислення підсумкових залишків на основі віртуальних залишків по місяцях.
        /// Підсумкові залишки використовуються для відображення в списку Номенклатура
        /// </summary>
