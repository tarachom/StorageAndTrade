...
namespace StorageAndTrade
{
    public partial class Form_ЗамовленняПостачальнику_ТабличнаЧастина_Товари : UserControl
    {
		...
		public void LoadRecords()
		{
			...
			querySelect.Joins.Add(new Join(JoinTable, Документи.ЗамовленняПостачальнику_Товари_TablePart.Номенклатура, querySelect.Table));
			...
			querySelect.Joins.Add(new Join(JoinTable, Документи.ЗамовленняПостачальнику_Товари_TablePart.Пакування, querySelect.Table));
			...
			querySelect.Joins.Add(new Join(JoinTable, Документи.ЗамовленняПостачальнику_Товари_TablePart.ХарактеристикаНоменклатури, querySelect.Table));
