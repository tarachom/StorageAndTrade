    ...
    public partial class Form_ПоступленняТоварівТаПослугЖурнал : Form
    {
        ...
        private void розхіднийКасовийОрдерToolStripMenuItem_Click(object sender, EventArgs e)
        {
			if (dataGridViewRecords.SelectedRows.Count > 0)
			{
				...
				Документи.РозхіднийКасовийОрдер_Objest розхіднийКасовийОрдер_Objest_Новий = new Документи.РозхіднийКасовийОрдер_Objest();
				розхіднийКасовийОрдер_Objest_Новий.New();
				...
				розхіднийКасовийОрдер_Objest_Новий.Організація = поступленняТоварівТаПослуг_Objest.Організація;
				розхіднийКасовийОрдер_Objest_Новий.Валюта = поступленняТоварівТаПослуг_Objest.Валюта;
				розхіднийКасовийОрдер_Objest_Новий.Каса = поступленняТоварівТаПослуг_Objest.Каса;
				розхіднийКасовийОрдер_Objest_Новий.Контрагент = поступленняТоварівТаПослуг_Objest.Контрагент;
				розхіднийКасовийОрдер_Objest_Новий.Договір = поступленняТоварівТаПослуг_Objest.Договір;
				розхіднийКасовийОрдер_Objest_Новий.Коментар = поступленняТоварівТаПослуг_Objest.Коментар;
				розхіднийКасовийОрдер_Objest_Новий.СумаДокументу = поступленняТоварівТаПослуг_Objest.СумаДокументу;
				...
				form_РозхіднийКасовийОрдерДокумент.Uid = розхіднийКасовийОрдер_Objest_Новий.UnigueID.ToString();
