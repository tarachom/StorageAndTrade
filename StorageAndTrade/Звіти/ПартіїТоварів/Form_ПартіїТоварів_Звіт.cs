...
SELECT 
    ...
    ПартіїТоварів_Місяць.{ВіртуальніТаблиціРегістрів.ПартіїТоварів_Місяць_TablePart.Документ} AS Документ,
...
ORDER BY Організація_Назва, ДокументПоступлення_Назва, Номенклатура_Назва, ХарактеристикаНоменклатури_Назва
";
...
SELECT 
    ...
    Документ_ПоступленняТоварівТаПослуг.{ПоступленняТоварівТаПослуг_Const.Назва} AS ДокументПоступлення_Назва,
    Документ_ПоступленняТоварівТаПослуг.{ПоступленняТоварівТаПослуг_Const.ДатаДок} AS ДокументПоступлення_ДатаДок,
    register.Документ,
...
ORDER BY period ASC, Організація_Назва, 
         ДокументПоступлення_ДатаДок ASC, Номенклатура_Назва, 
         ХарактеристикаНоменклатури_Назва
";
