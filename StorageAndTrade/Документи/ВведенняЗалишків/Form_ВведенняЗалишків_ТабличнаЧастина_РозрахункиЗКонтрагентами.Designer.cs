...
{
    partial class Form_ВведенняЗалишків_ТабличнаЧастина_РозрахункиЗКонтрагентами
    {
        /// <summary> 
        ...
        private void InitializeComponent()
        {
            ...
            this.Name = "Form_ВведенняЗалишків_ТабличнаЧастина_РозрахункиЗКонтрагентами";
            this.Size = new System.Drawing.Size(733, 248);
            this.Load += new System.EventHandler(this.Form_ВведенняЗалишків_ТабличнаЧастина_РозрахункиЗКонтрагентами_Load);
