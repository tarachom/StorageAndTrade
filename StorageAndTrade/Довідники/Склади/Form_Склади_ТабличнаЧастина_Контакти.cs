...
{
    public partial class Form_Склади_ТабличнаЧастина_Контакти : UserControl
    {
        public Form_Склади_ТабличнаЧастина_Контакти()
        {
            InitializeComponent();
		...
		/// </summary>
		public Довідники.Склади_Objest ДовідникОбєкт { get; set; }
		...
		public void LoadRecords()
		{
			...
			Довідники.Склади_Контакти_TablePart склади_Контакти_TablePart =
				new Довідники.Склади_Контакти_TablePart(ДовідникОбєкт);

			склади_Контакти_TablePart.Read();

            foreach (Довідники.Склади_Контакти_TablePart.Record record in склади_Контакти_TablePart.Records)
            {
		...
		public void SaveRecords()
        {
			...
			склади_Контакти_TablePart.Records.Clear();
			...
			foreach (Записи запис in RecordsBindingList)
            {
				...
				склади_Контакти_TablePart.Records.Add(
					new Довідники.Склади_Контакти_TablePart.Record()
					{
						Тип = ТипКІ,
			...
			склади_Контакти_TablePart.Save(true);
		}
