...
namespace StorageAndTrade_1_0.Документи
{
	...
	class ПоступленняТоварівТаПослуг_SpendTheDocument
	{
		public static bool Spend(ПоступленняТоварівТаПослуг_Objest ДокументОбєкт)
		{
			...
			Константи.Системні.ФоновіЗадачі_ОбчисленняВіртуальнихЗалишків_TablePart.Record record1 = new Константи.Системні.ФоновіЗадачі_ОбчисленняВіртуальнихЗалишків_TablePart.Record();
			record1.НазваРегістру = "ЗамовленняПостачальникам";
			record1.ПеріодОбчислення = ДокументОбєкт.ДатаДок;
			record1.ГрупаОбчислення = "День";
			record1.Дата = DateTime.Now;

			Константи.Системні.ФоновіЗадачі_ОбчисленняВіртуальнихЗалишків_TablePart фоновіЗадачі_ОбчисленняВіртуальнихЗалишків_TablePart = 
				new Константи.Системні.ФоновіЗадачі_ОбчисленняВіртуальнихЗалишків_TablePart();

			фоновіЗадачі_ОбчисленняВіртуальнихЗалишків_TablePart.Records.Add(record1);
			фоновіЗадачі_ОбчисленняВіртуальнихЗалишків_TablePart.Save(false);
