...
";
            ...
            ФункціїДляЗвітів.XmlDocumentSaveAndTransform(xmlDoc, @"Шаблони\РозрахункиЗПостачальниками_Залишки.xslt", false, "Розрахунки з постачальниками");
...
";
            ...
            ФункціїДляЗвітів.XmlDocumentSaveAndTransform(xmlDoc, @"Шаблони\РозрахункиЗПостачальниками_Документи.xslt", false, "Розрахунки з постачальниками");
...
";
        ...
        private void buttonOstatokAndOborot_Click(object sender, EventArgs e)
        {
            ...
            ФункціїДляЗвітів.XmlDocumentSaveAndTransform(xmlDoc, @"Шаблони\РозрахункиЗПостачальниками_ЗалишкиТаОбороти.xslt", false, "Розрахунки з постачальниками");
